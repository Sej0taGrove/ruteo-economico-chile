...
def extraer_sismos_usgs():
    ...
    print(f"[INFO] Consultando USGS API desde {start_time} hasta {end_time}...")
...
def guardar_json(data, filename):
    """
    Guarda los datos en archivo JSON en la carpeta actual del script.
    """
    output_dir = os.path.dirname(os.path.realpath(__file__))
    os.makedirs(output_dir, exist_ok=True)  # Se mantiene por si acaso
